...
public class SQLite implements DatabaseInterface {
    ...
    public void createTables() throws SQLException {
        try (Statement statement = connection.createStatement()) {
            ...
            statement.executeUpdate("CREATE TABLE IF NOT EXISTS mobspawner_mobs (" +
                    ...
                    "spawner_name TEXT NOT NULL, " +
                    "spawner_world TEXT NOT NULL, " +
                    "spawner_x REAL NOT NULL, " +
                    "spawner_y REAL NOT NULL, " +
                    "spawner_z REAL NOT NULL, " +
    ...
    public void savePlayerData(PlayerData playerData) throws SQLException {
        String query = "INSERT INTO mobspawner_players (uuid, mobs_killed, damage_dealt) " +
                "VALUES (?, ?, ?) " +
                "ON CONFLICT(uuid) DO UPDATE SET mobs_killed = excluded.mobs_killed, damage_dealt = excluded.damage_dealt";
        try (PreparedStatement ps = connection.prepareStatement(query)) {
